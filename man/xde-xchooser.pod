...
When I<true>, spefifies that the user defined in
...
XDMCP Greeter program and may provide an immeditate login option in
...
=item B<xlogin>.B<Login.width>

=item B<xlogin>.B<Login.height>

=item B<xlogin>.B<Login.x>

=item B<xlogin>.B<Login.y>
