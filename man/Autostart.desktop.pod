...
Autostart.desktop -- Autostart .desktop file format

=head1 SYNOPSIS

B<$XDG_CONFIG_HOME>I</autostart/*.desktop>

B<$XDG_CONFIG_DIRS>I</autostart/*.desktop>

=head1 DESCRIPTION

This manual page describes the format of the C<Autostart> F<.desktop>
file format.

=head1 FILE FORMAT

There is only one format for the F<.desktop> file of type C<Autostart>.
