...
resource name and class (C<xde-greeter>, C<XDE-Greeter>).  When no resource
...
=item B<xde-greeter>.B<theme.icon>: I<NAME>
...
=item B<xde-greeter>.B<theme.sound>: I<NAME>
...
Xft support.
This resource is not used by B<xde-greeter>.
