...
XSession.desktop -- XSession .desktop file format

=head1 SYNOPSIS

B<$XDG_DATA_HOME>I</xsessions/*.desktop>

B<$XDG_DATA_DIRS>I</xsessions/*.desktop>

=head1 DESCRIPTION

This manual page describes the format of the C<XSession> F<.desktop>
file format.

=head1 FILE FORMAT

There are two formats for the F<.desktop> file of type C<XSession>:
