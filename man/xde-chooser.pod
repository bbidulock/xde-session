...
subdirectory describing the window manager session.  Som commonly
...
in this groug encountered sets the mode of the program.  When no command
...
C<[Desktop]> section.  This file will be written whenever the a new
