...
=item B<-U>, B<--audio>, B<--pulse-audio>

Wait for an X11 pulse audio server to appear (or for root window
properties to be set) before running the command and exiting.
